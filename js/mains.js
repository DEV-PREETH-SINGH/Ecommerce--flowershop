                    ...
                    if( cartItems && productContainer) {
                        productContainer.innerHTML = '';
                            ...
                            <div class="proceed_payment">
                                <button id="myBtn1" onclick="sendmail2(${deliverycharge});confirm();clearcart();"><a href="shop.html">Click to Confirm</a></button>
                            </div>
                            `
            }
